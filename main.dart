...
class _MainNavigationState extends State<MainNavigation> {
  ...
  final List<Widget> _pages = [
      ...
      child: HomePage(
        onTryAR: () {
          Navigator.of(context).push(
            MaterialPageRoute(builder: (_) => const TryARPage()),
          );
        },
        onSignInStudent: () {},
        onSignInPolicyMaker: () {},
    ...
    InsightsPage(),
    PlaceholderPage(title: "Scenarios Page"),
    ProfilePageScreen(),
  ];
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                Icon(icon, size: 22, color: isDark ? Colors.white : Colors.green),
